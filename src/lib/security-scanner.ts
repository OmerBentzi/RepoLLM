/**
 * Multi-layered security scanning using open-source tools + GPT-5 Instant AI
 * Zero external API costs - uses npm audit, ESLint security, regex patterns, and GPT-5 Instant
 */
